...
export type NotificationListQuery = {
  status?: NotificationListStatus | string;
  page?: number | string;
  limit?: number | string;
  /** Optional additive filter used by Mobile without changing the Web contract. */
  entityTypes?: string[];
...
export type CurrentNotificationUser = AuthenticatedUser;
